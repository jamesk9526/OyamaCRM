...
![DonorCRM Dashboard](screenshots/donor-crm/2026-05-13/donor-dashboard-desktop.png)

#### Steward Paths Builder — Visual Workflow Editing
![Steward Paths Builder](screenshots/donor-crm/2026-05-13/steward-paths-builder-desktop.png)

#### Constituents — Donor Management & Profiles
![Constituents](screenshots/donor-crm/2026-05-13/constituents-list-desktop.png)

#### Constituent Detail — Giving, Notes, and Timeline
![Constituent Detail](screenshots/donor-crm/2026-05-13/constituent-profile-desktop.png)

#### Donations — Gift Entry, Ledger & Receipt Generation
![Donations](screenshots/donor-crm/2026-05-13/donations-list-desktop.png)

#### Donation Add Form — Structured Gift Capture
![Donation Form](screenshots/donor-crm/2026-05-13/donation-form-desktop.png)

#### Campaigns — Fundraising Campaigns & Goal Tracking
![Campaigns](screenshots/donor-crm/2026-05-13/campaigns-list-desktop.png)

#### Grants — Grant Research, Deadlines, and Writing Workspace
![Grants](screenshots/donor-crm/2026-05-13/grants-workspace-desktop.png)

#### Tasks — Stewardship Workflow & Due Dates
![Tasks](screenshots/donor-crm/2026-05-13/tasks-workspace-desktop.png)

#### Communications — Email Campaigns & Outreach
![Communications](screenshots/donor-crm/2026-05-13/communications-workspace-desktop.png)

#### Reports — Analytics, Dashboards & Exports
![Reports](screenshots/donor-crm/2026-05-13/reports-desktop.png)
...
> Donor screenshot pack refreshed from `docs/screenshots/donor-crm/2026-05-13` (legacy donor images archived under `docs/screenshots/donor-crm/archive/2026-05-13-legacy-readme`).
