...
| Donor Dashboard component consolidation | Working | `app/components/dashboard/NaturalisticDonorDashboard.tsx`, `app/components/dashboard/DonorDashboardOverviewSections.tsx`, `app/components/dashboard/shared/DashboardPrimitives.tsx`, `app/features/donor-dashboard/services/dashboard-client-service.ts` | The mounted dashboard now composes shared metric cards, panels, status pills, mini tiles, and live-data overview sections. Three unreachable legacy dashboard implementations and the unused duplicate customizer were removed; core summary/retention loading, contracts, currency formatting, and report links are centralized. |
