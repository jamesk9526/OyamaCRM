...
- **Mixed/partial:** email campaigns + automations are persisted but runtime execution/telemetry is incomplete (`server/src/routes/email-campaigns.ts`, `server/src/routes/automations.ts`).
