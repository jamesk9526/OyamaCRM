...
export const CRM_CONSTITUENT_FIELDS: readonly CrmField[] = [
  ...
  { key: "entityKind",               label: "Entity Kind",                   required: false, group: "Organization", sensitive: false },
  { key: "organizationCategory",     label: "Organization Category",         required: false, group: "Organization", sensitive: false },
  { key: "contactFirstName",         label: "Primary Contact First Name",    required: false, group: "Organization", sensitive: false },
  { key: "contactLastName",          label: "Primary Contact Last Name",     required: false, group: "Organization", sensitive: false },
  { key: "contactTitle",             label: "Primary Contact Title",         required: false, group: "Organization", sensitive: false },
