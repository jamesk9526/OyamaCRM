// Compassion CRM — Clients placeholder page.
import ComingSoonBadge from "@/app/components/ui/ComingSoonBadge";

/** Clients page: manage client records, profiles, and histories. */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-dashed border-blue-200 p-10 text-center">
        <p className="text-gray-400 text-sm">Client management is coming soon.</p>
      </div>
    </div>
  );
}
