// Compassion CRM — Assessments placeholder page.
import ComingSoonBadge from "@/app/components/ui/ComingSoonBadge";

/** Assessments page: record and review client assessments. */
export default function CompassionAssessmentsPage() {
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Record and review client assessments.</p>
        </div>
      </div>
      <div className="bg-white rounded-xl border border-dashed border-blue-200 p-10 text-center">
        <p className="text-gray-400 text-sm">Assessments are coming soon.</p>
      </div>
    </div>
  );
}
