...
export const PROJECT_STATUS_ITEMS: ProjectStatusItem[] = [
  ...
  },
  {
    ...
    status: "Working",
    dataSource: "Real API Data",
    notes: "Tasks page uses /api/tasks for list/create/complete/delete and now supports templates + bulk reassignment through dedicated endpoints.",
    nextStep: "Add segment-driven bulk task creation and workload balancing rules.",
  },
  {
    area: "Donor CRM",
  ...
  },
  {
    ...
    status: "Partial",
    dataSource: "Mixed Real/Demo Data",
    notes: "Editor persists templateJson/body to /api/email-campaigns/:id, now includes campaign media uploads and recipient-level timeline writeback.",
    nextStep: "Expand merge-field completeness and compliance workflow depth.",
  },
  {
    area: "Donor CRM",
    ...
    status: "Partial",
    dataSource: "Real API Data",
    notes: "Steward Path records/actions are DB-backed, with run-history filtering, diagnostics API, and retry controls now available.",
    nextStep: "Add adaptive retry backoff tuning and longer-window failure trend dashboards.",
  },
  {
    area: "Donor CRM",
  ...
  },
  {
    ...
    status: "Working",
    dataSource: "Real API Data",
    notes: "Reports tab fetches summary/monthly/retention/top-donor/campaign endpoints, includes freshness metadata, and supports server-side permission-gated exports.",
    nextStep: "Add scheduled report delivery and export job history.",
  },
  {
    area: "Events CRM",
  ...
  },
  {
    ...
    status: "UI Only",
    dataSource: "Static Demo UI",
    notes: "Branding/Workspaces/Donor/Scheduling/Forms/Email/Integrations/Import-Export use SettingsPlaceholderPage.",
