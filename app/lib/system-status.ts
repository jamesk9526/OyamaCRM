...
export function getPublicBuildInfo(env: NodeJS.ProcessEnv = process.env): PublicBuildInfo {
  return {
    appName: env.NEXT_PUBLIC_APP_NAME ?? env.APP_NAME ?? "OyamaCRM v1.3",
...
export const FEATURE_READINESS: FeatureReadinessItem[] = [
  {
    ...
    linkedPlanFile: "docs/plans/phase-01-foundation-and-auth.md",
  },
  {
  ...
  },
  {
    ...
    linkedPlanFile: "docs/plans/phase-02-constituents-and-timeline.md",
  },
  {
    ...
    linkedPlanFile: "docs/plans/phase-03-donations-funds-campaigns.md",
  },
  {
    ...
    linkedPlanFile: "docs/plans/phase-04-receipts-tasks-communications.md",
    priority: "P2",
  ...
  },
  {
    ...
    missingPieces: "Long-term failure trend dashboards and advanced sequence-node execution coverage still need hardening.",
    nextAction: "Add long-window diagnostics visualization and complete advanced sequence-node execution coverage.",
    linkedPlanFile: "docs/plans/phase-06-groups-segments-automation.md",
    priority: "P2",
    successCriteria: "Operators can view 30-day failure trends and advanced sequence nodes execute with production-safe behavior.",
    copilotPrompt: "Expand Steward Paths operations visibility and advanced execution coverage. Extend server/src/routes/automations.ts diagnostics endpoints for 7/30-day failure trend slices and update app/automations/page.tsx with trend cards/filters. Then finish remaining advanced node-type processors in server/src/services/steward-paths-sequence-engine.ts with tests and keep existing retry endpoint behavior.",
  },
  {
    feature: "Events & Gala",
    ...
    linkedPlanFile: "docs/plans/phase-07-events-and-gala.md",
    priority: "P1",
  ...
  },
  {
    ...
    linkedPlanFile: "docs/plans/phase-08-security-integrations-ai-ops.md",
    priority: "P0",
