          ...
          <section className="rounded-xl border border-gray-200 bg-white p-4">
            ...
            <div className="mt-3 space-y-2">
              {pathDrafts.slice(0, 12).map((draft) => (
                <Link key={draft.id} href="/steward-paths" className="block rounded-lg border border-gray-200 px-3 py-2 hover:bg-gray-50">
                  <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              {pathDrafts.length === 0 && (
                <EmptyStateCard
                  ...
                  actions={(
                    <>
                      <ActionButton label="Open Steward Paths" variant="primary" href="/steward-paths" />
