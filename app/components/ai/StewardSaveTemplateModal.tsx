...
export default function StewardSaveTemplateModal({
  ...
  return (
    ...
    >
      <div className="grid gap-4 bg-[#020617] px-4 pb-4 pt-12 text-slate-100 xl:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)]">
        ...
        <aside className="space-y-3 rounded-xl border border-white/10 bg-[#0b1220] p-3 xl:sticky xl:top-4 xl:max-h-[calc(100dvh-8rem)] xl:overflow-y-auto">
          <div className="flex items-center justify-between gap-2">
            <p className="text-[11px] font-semibold uppercase tracking-wide text-cyan-200">Rendered preview</p>
            <span className="rounded-full border border-cyan-300/30 bg-cyan-400/10 px-2 py-0.5 text-[10px] font-medium text-cyan-200">Merge fields resolved</span>
          </div>

          <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_max-content] xl:grid-cols-1">
            <label className="block space-y-1">
              <span className="text-[11px] font-semibold uppercase tracking-wide text-slate-400">Preview donor</span>
              <select
            ...
            <button
              ...
              className="h-fit self-end rounded-lg border border-white/15 bg-slate-900/70 px-3 py-2 text-[11px] font-medium text-slate-300 hover:bg-slate-800"
            >
              Shuffle sample
            </button>
          </div>
          ...
          <div className="rounded-lg border border-white/10 bg-[#020817] p-3">
            <p className="text-xs font-semibold text-slate-200">{resolvedDonor.fullName}</p>
            <p className="mt-1 text-[11px] text-slate-400">Last gift {resolvedDonor.lastGiftAmount} on {resolvedDonor.lastGiftDate}</p>
            <p className="text-[11px] text-slate-400">Campaign: {resolvedDonor.campaignName}</p>
          </div>

          <div className="rounded-lg border border-cyan-300/20 bg-[#020817] p-3">
            <p className="text-[11px] font-semibold uppercase tracking-wide text-slate-400">Subject preview</p>
            <p className="mt-1 text-sm text-slate-100">{previewSubject || "(No subject yet)"}</p>
            <p className="mt-2 text-[11px] font-semibold uppercase tracking-wide text-slate-400">Preview text</p>
            <p className="mt-1 text-sm text-slate-300">{previewText || "(No preview text yet)"}</p>
          </div>

          <div className="rounded-lg border border-cyan-300/20 bg-[#020817] p-3">
            <p className="text-[11px] font-semibold uppercase tracking-wide text-slate-400">Email render</p>
