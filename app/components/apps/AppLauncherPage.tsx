...
const APPS: LauncherApp[] = [
  ...
  { id: "steward", name: "AGENTSteward", description: "Explore donor context and prepare CRM work with AI assistance.", href: "/steward-ai-workspace", category: "Operations", icon: Sparkles, tone: "bg-violet-50 text-violet-700" },
