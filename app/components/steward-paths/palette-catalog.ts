...
export const PALETTE_ITEMS: NodePaletteItem[] = [
  ...
  { kind: "trigger.added_to_segment", category: "trigger", label: "Added to segment", summary: "Donor joins a segment.", readiness: "partially-working" },
  { kind: "trigger.donor_lapsed", category: "trigger", label: "Donor becomes lapsed", summary: "No gift inside a window.", readiness: "partially-working" },
  { kind: "trigger.pledge_due", category: "trigger", label: "Pledge due", summary: "Pledge installment becomes due.", readiness: "partially-working" },
  { kind: "trigger.event_attended", category: "trigger", label: "Event attended", summary: "Constituent attended an event.", readiness: "not-implemented" },
  ...
  { kind: "timing.until_date", category: "timing", label: "Wait until date", summary: "Pause until a specific date.", readiness: "not-implemented" },
  { kind: "timing.until_weekday_time", category: "timing", label: "Wait until weekday/time", summary: "Hold for the next allowed window.", readiness: "not-implemented" },
  { kind: "timing.after_last_gift", category: "timing", label: "Wait until after last gift", summary: "Anchor delay to last donation.", readiness: "not-implemented" },
  ...
  { kind: "email.send_review_request", category: "email", label: "Send review request", summary: "Notify a reviewer.", readiness: "partially-working" },
  { kind: "email.add_to_sequence", category: "email", label: "Add to email sequence", summary: "Enroll donor in an email sequence.", readiness: "not-implemented" },
  { kind: "email.schedule_blast", category: "email", label: "Schedule email blast", summary: "Queue a campaign send.", readiness: "partially-working" },
  { kind: "email.wait_for_open", category: "email", label: "Wait for email open/click", summary: "Pause until donor engages.", readiness: "not-implemented" },
  { kind: "email.mark_failed", category: "email", label: "Mark email failed/bounced", summary: "Record delivery failure.", readiness: "not-implemented" },
  ...
  { kind: "print.require_print_approval", category: "print", label: "Require print approval", summary: "Block print until approval.", readiness: "partially-working" },
  ...
  { kind: "task.escalate_overdue", category: "task", label: "Escalate overdue task", summary: "Notify lead when overdue.", readiness: "not-implemented" },
  ...
  { kind: "logic.email_engagement_condition", category: "logic", label: "Email engagement condition", summary: "Branch on opens/clicks.", readiness: "not-implemented" },

  // Safety / Review
  { kind: "safety.require_human_approval", category: "safety", label: "Require human approval", summary: "Hold for explicit approval.", readiness: "partially-working" },
  { kind: "safety.pause_path", category: "safety", label: "Pause path", summary: "Pause this enrollment.", readiness: "working" },
  { kind: "safety.notify_staff", category: "safety", label: "Notify staff", summary: "Send a heads-up to the team.", readiness: "not-implemented" },
