...
function resolveActiveDonorRibbonTab(pathname: string): string {
  ...
  if (pathname.startsWith("/communications") || pathname.startsWith("/letters-printables") || pathname.startsWith("/email-builder") || pathname.startsWith("/livecom")) return "Outreach";
