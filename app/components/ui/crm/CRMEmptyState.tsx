...
export default function CRMEmptyState({ title, description, action, icon }: CRMEmptyStateProps) {
  return (
    <CRMCard className="text-center" padding="lg">
      {icon ? <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-emerald-50 text-emerald-700">{icon}</div> : null}
