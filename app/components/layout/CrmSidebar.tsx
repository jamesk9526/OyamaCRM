...
const VARIANT_STYLES: Record<CrmSidebarVariant, SidebarVariantStyles> = {
  ...
  watchdog: {
    aside: "bg-[#0a0f19] border-r border-[#1f2937]",
    navSurface: "",
    heading: "text-red-300",
    headingMuted: "hover:text-red-200",
    itemActive: "text-red-200 bg-red-500/10 ring-1 ring-red-500/40 font-semibold",
    itemInactive: "text-gray-300 hover:bg-gray-800/60 hover:text-gray-100",
    iconActive: "text-red-300 bg-red-500/10",
    iconInactive: "text-gray-400 bg-[#111827] group-hover:bg-[#1f2937] group-hover:text-gray-200",
    badge: "bg-red-500/20 text-red-200",
    sectionBorder: "border-transparent",
    sectionHover: "hover:border-[#263245] hover:bg-[#0f172a]",
    footer: "border-t border-[#1f2937] bg-[#0a0f19]",
    footerText: "text-gray-400",
    collapseButton: "border-[#334155] bg-[#111827] text-gray-300 hover:text-white hover:bg-[#1f2937]",
    tooltip: "border-[#334155] bg-[#111827] text-gray-100 shadow-xl",
    tooltipSubtitle: "text-gray-300",
    divider: "bg-[#334155]",
  },
};
