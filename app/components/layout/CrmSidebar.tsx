...
export type CrmSidebarVariant = "donor" | "events" | "watchdog";
...
const DONOR_ACCENT_OVERRIDES: Record<DonorAccentTone, { iconActive: string; accent: string; focusRing: string; buttonTone: string }> = {
  green: {
    iconActive: "text-[#cfe4fa]",
    accent: "bg-[#0f6cbd]",
    focusRing: "focus-visible:ring-[#60cdff]",
    buttonTone: "border-white/15 bg-white/[0.06] text-slate-100 hover:border-[#60cdff]/60 hover:bg-[#0f6cbd]/35",
  },
  blue: {
...
const VARIANT_STYLES: Record<CrmSidebarVariant, SidebarVariantStyles> = {
  donor: {
    aside: "bg-[linear-gradient(180deg,#242424_0%,#1f1f1f_58%,#181818_100%)] border-r border-[#424242]",
    navSurface: "",
    heading: "text-slate-400",
    headingMuted: "hover:text-white",
    itemActive: "text-white bg-[#0f6cbd] font-semibold shadow-[inset_3px_0_0_#60cdff]",
    itemInactive: "text-slate-200 hover:bg-white/[0.08] hover:text-white",
    iconActive: "text-[#cfe4fa]",
    iconInactive: "text-slate-300 group-hover:text-white",
    badge: "bg-white/10 text-slate-100 ring-1 ring-white/15",
    sectionBorder: "border-transparent",
    sectionHover: "hover:bg-white/[0.04]",
    footer: "border-t border-[#424242] bg-[#181818]",
    footerText: "text-slate-400",
    collapseButton: "border-white/15 bg-white/[0.06] text-slate-200 hover:border-[#60cdff]/60 hover:bg-[#0f6cbd]/35 hover:text-white",
    tooltip: "border-[#424242] bg-[#242424] text-white shadow-lg",
    tooltipSubtitle: "text-slate-300",
    divider: "bg-white/15",
    accent: "bg-[#0f6cbd]",
  },
  events: {
...
/** Shared CRM sidebar renderer used by Donor, Events, and Watchdog modules. */
