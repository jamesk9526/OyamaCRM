    ...
    <div className="relative">
      ...
      >
        {tone.spinner ? (
          ...
          <span className={`${compact ? "h-2.5 w-2.5" : "h-2.5 w-2.5"} rounded-full ${tone.dotTone} ${tone.dotPulse ? "animate-pulse" : ""}`} aria-hidden="true" />
        )}
        {compact ? (
          <>
            <span className="hidden 2xl:inline">Steward</span>
