...
const PERM_LABELS: Record<string, string> = {
  ...
  "steward_paths.view": "Steward Paths: View",
  "steward_paths.create": "Steward Paths: Create",
  "steward_paths.edit": "Steward Paths: Edit",
  "steward_paths.activate": "Steward Paths: Activate",
  "steward_paths.archive": "Steward Paths: Archive",
  "steward_paths.enroll": "Steward Paths: Enroll",
  "steward_paths.pause": "Steward Paths: Pause/Resume",
  "steward_paths.manage_all": "Steward Paths: Manage All",
  "steward_paths.process_due_steps": "Steward Paths: Process Due Steps",
  "steward_paths.email_auto_send": "Steward Paths: Allow Auto Send",
  "letters.view": "Letters: View",
  "letters.create": "Letters: Create Templates",
  "letters.edit": "Letters: Edit Templates",
  "letters.archive": "Letters: Archive Templates",
  "letters.generate": "Letters: Generate",
  "letters.generate_batch": "Letters: Batch Generate",
  "letters.manage_print_queue": "Letters: Manage Print Queue",
  "letters.manage_mail_queue": "Letters: Manage Mail Queue",
  "letters.manage_signatures": "Letters: Manage Signatures",
  "letters.manage_branding": "Letters: Manage Branding",
  "letters.create_email_draft": "Letters: Create Email Draft",
  "letters.export_pdf": "Letters: Export PDF",
  "letters.view_sensitive_merge_data": "Letters: View Sensitive Merge Data",
  "letters.manage_all": "Letters: Full Manage Scope",
