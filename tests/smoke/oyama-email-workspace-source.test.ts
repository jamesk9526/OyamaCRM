...
expect(builder).toContain("Ready-made layouts");
    ...
    expect(builder).toContain("Block Library");
    expect(builder).toContain("BLOCK_LIBRARY_DRAWERS");
    expect(builder).toContain("Merge Field Drawer");
    expect(builder).toContain("application/x-oyama-email-block");
    expect(builder).toContain("Add or drop a block");
