...
describe("letters PDF layout parsing", () => {
  ...
  it("compresses a trailing fixed spacer before an otherwise fitting signature", async () => {
    const pdf = await renderGeneratedLetterPdf({
      templateName: "Fixed Spacer Signature",
      subject: "",
      constituentName: "Test Donor",
      generatedAt: new Date("2026-09-08T12:00:00.000Z"),
      mergedPrintBody: [
        `<p>${"Thank you for supporting compassionate care in our community. ".repeat(18)}</p>`,
        '<table data-letter-table="true"><tbody><tr><th>Gift Detail</th><th>Value</th></tr><tr><td>Donation Amount</td><td>$50.00</td></tr><tr><td>Donation Date</td><td>September 8, 2026</td></tr></tbody></table>',
        '<div data-letter-spacer="72" style="height:72px;"></div>',
      ].join(""),
      branding: {
        organizationName: "The Pregnancy Care Center",
        tagline: "",
  ...
  it("compacts a saved run of blank layout blocks before an automatic signature", async () => {
    const pdf = await renderGeneratedLetterPdf({
      templateName: "Legacy Blank Layout Signature",
      subject: "",
      constituentName: "Test Donor",
      generatedAt: new Date("2026-09-08T12:00:00.000Z"),
      mergedPrintBody: [
        `<p>${"Thank you for supporting compassionate care in our community. ".repeat(18)}</p>`,
        '<table data-letter-table="true"><tbody><tr><th>Gift Detail</th><th>Value</th></tr><tr><td>Donation Amount</td><td>$50.00</td></tr><tr><td>Donation Date</td><td>September 8, 2026</td></tr></tbody></table>',
        '<div data-letter-spacer="72" style="height:72px;"></div><p></p><table><tbody></tbody></table><p></p><p></p>',
      ].join(""),
      branding: {
        organizationName: "The Pregnancy Care Center",
        tagline: "",
