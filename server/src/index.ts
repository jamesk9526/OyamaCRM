...
import donorProfileRoutes from "./routes/donor-profile.js";
import donorProfileResearchRoutes from "./routes/donor-profile-research.js";
...
app.use("/api/donor-research", donorProfileResearchRoutes, donorProfileRoutes);
app.use("/api/donor-profile", donorProfileResearchRoutes, donorProfileRoutes);
