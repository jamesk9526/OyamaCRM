...
export const EMAIL_MERGE_TOKEN_ALIASES: Record<string, string> = {
  first: "firstName",
  "donor.first": "firstName",
  last: "lastName",
  "donor.last": "lastName",
  name: "fullName",
  "donor.name": "fullName",
  preferred: "preferredName",
  "donor.preferred": "preferredName",
  amount: "donationAmount",
  "giftAmount": "donationAmount",
  giftDate: "gift.date",
  "donor.giftDate": "gift.date",
  donationDate: "gift.date",
  totalGiving: "totalLifetimeGiving",
  "donor.totalGiving": "totalLifetimeGiving",
  ...
  "donationAmountType": "giftAmountType",
...
export const EMAIL_MERGE_FIELD_GROUPS: EmailMergeFieldGroupDescriptor[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { token: "{{giftAmountType}}", description: "Current gift amount type (one-time or recurring)" },
  ...
  },
  {
    ...
    fields: [
      ...
      { token: "{{gift.amountType}}", description: "Compatibility alias for gift amount type" },
      { token: "{{donation.amountType}}", description: "Compatibility alias for gift amount type" },
