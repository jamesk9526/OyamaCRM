...
const DEFAULT_CONFIG: StewardAiConfig = {
  ...
  systemPrompt: [
    ...
    "- The user's requested deliverable format is mandatory.",
    "- If the user asks for a draft email, output a real draft email, not donor data analysis.",
    "- Do not include tool traces, raw CRM field dumps, or internal planning text in final user content.",
